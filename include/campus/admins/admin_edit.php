...
$sqllms	= $dblms->querylms("SELECT a.adm_id, a.adm_status, a.adm_type, a.adm_username, a.adm_fullname,
								   a.adm_email, a.adm_phone, a.adm_photo, a.adm_photo, a.id_campus, c.campus_name
								FROM ".ADMINS." a 
...
echo '			</select>
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<select class="form-control" readonly data-width="100%"> 
				<option value="">'.$rowsvalues['campus_name'].'</option>
		</select>
		</div>
	</div>
</div>
...
//------------------------------------------------
	$sqllmsroles  = $dblms->querylms("SELECT role_id, role_status, role_name, role_type 
										...
										AND role_status = '1' AND id_type IN (2, 3)
										AND is_deleted != '1'
