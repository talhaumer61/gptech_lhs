                    ...
                    <section class="panel panel-featured panel-featured-primary">
                        ...
                        <div class="panel-body">';
                            $sqlStudent = $dblms->querylms("SELECT c.class_name, cs.section_name, st.*
                                                            ...
                                                            AND st.id_campus = '" . cleanvars($_SESSION['userlogininfo']['LOGINCAMPUS']) . "' 
                                                            AND st.is_deleted = '0'
...
<script type="text/javascript">
    ...
    //     // Use SheetJS to generate an Excel file with the selected rows
    //     const workbook = XLSX.utils.book_new();
    //     const worksheet = XLSX.utils.aoa_to_sheet(selectedRows);
