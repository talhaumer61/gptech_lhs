...
// STUDENTS
$sqllmsleaves	= $dblms->querylms("SELECT COUNT(id) as total_leaves
										FROM ".LEAVE."
										WHERE id_campus	= '".$_SESSION['userlogininfo']['LOGINCAMPUS']."'
										AND status = '2'
										AND is_deleted	= '0'
									");								  
$value_leave = mysqli_fetch_array($sqllmsleaves);
...
<div class="counter-link">
	<div class="col-lg-12 col-md-12 col-sm-12">
		...
		<div class="finance-chart-box">
			...
			<div class="finance-chart-header clearfix">

				<h3 class="pull-left">
					<i class="fa fa-bar-chart"></i>
					Financial Overview - '.date('F Y', strtotime($today)).'
				</h3>';
				/*
				echo'
				<div class="pull-right finance-total">
					Total Expected:
					<strong>
			...
			<section class="panel panel-featured-left panel-featured-primary">
				<div class="panel-body">
					<div class="widget-summary widget-summary-sm">
						...
						<div class="widget-summary-col">
							<div class="summary">
								<h4 class="title"><b>Pending Leaves</b></h4>
								<div class="info">
									<strong class="amount text-primary text-uppercase">'.$value_leave['total_leaves'].'</strong>
								</div>
							</div>
						</div>
					</div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var chart = new ApexCharts(
        document.querySelector("#financeBarChart"),
        options
    );
