...
if(mysqli_num_rows($sqllms) > 0){
    ...
    <header class="panel-heading">
		...
		echo'
		'.$rowsvalues['type_name'].' Datesheet of Class <b>'.$rowsvalues['class_name'].'</b></h2>
	</header>
	...
	<div class="panel-footer">
		<div class="text-right">
			<a href="exam_datesheet_print.php?id='.$_GET['routine'].'" class="btn btn-sm btn-primary " target="_blank">
