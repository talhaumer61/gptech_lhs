...
echo '
                <input type="checkbox" name="subjects'.$valClass['std_id'].'['.$r1.$key.']" id="sub_ch_'.$r1.'" class="role_'.$r1.' check_all" value="1" style="transform : scale(1.0); margin-right: 10px;" '.(isset($_POST['demandId'])? (in_array($val['subject_id'], $splited_id_subjects) ? 'checked' : '' ) : '' ).'>
