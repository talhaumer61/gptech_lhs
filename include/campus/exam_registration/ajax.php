...
<thead>
    ...
    <tr>
        ...
        for ($i=1; $i <= mysqli_num_rows($sqllmsSubjects) ; $i++) { 
            echo'
            <th class="center"><input type="checkbox" id="subject_select_all_'.$i.'" style="transform : scale(1.0; margin-right: 10px;" checked></th>';
        }
        echo'
    </tr>
</thead>
...
echo '
                <input type="checkbox" name="subjects'.$valClass['std_id'].'['.$r1.$key.']" id="sub_ch_'.$r1.'" class="role_'.$r1.' check_all subject_select_all_'.$subjectR.'" value="1" style="transform : scale(1.0); margin-right: 10px;" '.(isset($_POST['demandId'])? (in_array($val['subject_id'], $splited_id_subjects) ? 'checked' : '' ) : '' ).'>
                ...
                <script>
                    $(document).ready(function(){
                        ...
                        $("#subject_select_all_'.$subjectR.'").click(function(){
                            $(".subject_select_all_'.$subjectR.'").prop("checked", $(this).prop("checked"));
                        });
                    });
                </script>
            </td>   
