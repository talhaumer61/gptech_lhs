            ...
            <div class="panel-body">                
                ...
                <div id="getfeeamount">
                    <table class="table table-hover table-striped table-condensed mb-none">
                        ...
                        <tbody>';
                                $sqllmsCats  = $dblms->querylms("SELECT c.cat_id, c.cat_name, s.transport_fee, d.amount
                                                                    FROM ".FEE_CATEGORY." c
                                                                    ...
                                                                    INNER JOIN ".STUDENTS." s ON s.id_section = f.id_section
                                                                     WHERE c.cat_status = '1' AND s.std_id = '".$rowsvalues['id_std']."' AND f.id_class = '".$rowsvalues['id_class']."'
                                                                     AND f.id_campus = '".cleanvars($_SESSION['userlogininfo']['LOGINCAMPUS'])."' AND f.id_session = '".cleanvars($_SESSION['userlogininfo']['ACADEMICSESSION'])."'
                                ...
                                while($valCats = mysqli_fetch_array($sqllmsCats)) {
                                    ...
                                    if($valCats['cat_id'] == 5) {
                                        $cat_amount = $valCats['transport_fee'];
                                    } else {
