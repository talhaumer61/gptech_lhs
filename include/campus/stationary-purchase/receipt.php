...
if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || ($_SESSION['userlogininfo']['LOGINTYPE']  == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '52', 'view' => '1'))){ 
    //-----------------------------------------------------
    $sqllms	= $dblms->querylms("SELECT p.pur_id, p.pur_status, p.pur_pay_status, p.pur_pay_invoice, p.pur_receipt_no, p.pur_total_amount, p.pur_paid_amount, p.pur_payable, p.dated, p.pur_note, c.campus_name 
