...
if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '1', 'add' => '1'))){
	$sqllms	= $dblms->querylms("SELECT id, form_no, status, name, fathername, std_fathercnic, gender, cell_no, address, id_class, note
			...
			<section class="panel panel-featured panel-featured-primary">
				<form action="students.php" class="mb-lg validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
					...
					<div class="panel-body">
							...
							<div class="row mt-sm">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="std_fathercnic" id="std_fathercnic" value="'.$rowsvalues['std_fathercnic'].'" required title="Must Be Required" >
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
									...
									<div class="form-group" id="getclasssection">
										...
										<select class="form-control" data-plugin-selectTwo data-width="100%" name="id_section">
											...
											$sqllmsSec	= $dblms->querylms("SELECT section_id, section_name 
																FROM ".CLASS_SECTIONS."
																WHERE section_status = '1' AND id_class='".$rowsvalues['id_class']."'
																AND id_campus ='".$_SESSION['userlogininfo']['LOGINCAMPUS']."'
																ORDER BY section_id ASC");
											while($valueSec = mysqli_fetch_array($sqllmsSec)) {
												echo '<option value="'.$valueSec['section_id'].'">'.$valueSec['section_name'].'</option>';
											}
											echo '
										</select>
									</div>
						...
						<div class="alert alert-danger"> Please Firstr Add Section To Add Student.</div>
					</div>
