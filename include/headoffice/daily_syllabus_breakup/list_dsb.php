...
<tr>
	...
	<td style="text-align:center;">'.get_status($rowsvalues['dsb_status']).'</td>
	<td width="120px;">
	...
	echo'
		<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom(\'include/modals/daily_syllabus_breakup/modal_dsb_update.php?id='.$rowsvalues['dsb_id'].'\');"><i class="glyphicon glyphicon-edit"></i></a>';
	}
	if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '60', 'delete' => '1'))){ 
	echo'
		<a href="#" class="btn btn-danger btn-xs" onclick="confirm_modal(\'dsb_dlp.php?deleteid='.$rowsvalues['dsb_id'].'\');"><i class="el el-trash"></i></a>';
	}
	echo'
	</td>
</tr>';
