	...
	<section class="panel panel-featured panel-featured-primary">
		<header class="panel-heading">';
			if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '71', 'add' => '1'))){ 
				echo'
					<a href="exam_demand_challans.php?view=add_single" class="btn btn-primary btn-xs pull-right"><i class="fa fa-plus-square"></i> Make Single Challan</a>
					<a href="exam_demand_challans.php?view=add_bulk" style="margin-right:5px;" class="btn btn-primary btn-xs pull-right"><i class="fa fa-plus-square"></i> Make Bulk Challan</a>
				';
			}
								...
								echo '
									...
									if($rowsvalues['status'] != '1'){
										if(($_SESSION['userlogininfo']['LOGINTYPE']  == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '71', 'edit' => '1'))){ 
											echo '
												<a href="#show_modal" class="modal-with-move-anim-pvs btn btn-primary btn-xs" onclick="showAjaxModalZoom(\'include/modals/exam_demand/challans/edit.php?id='.$rowsvalues['id'].'\');"><i class="glyphicon glyphicon-edit"></i></a>';
										}
										echo '<a href="#" class="btn btn-danger btn-xs ml-xs" onclick="confirm_modal(\'exam_demand_challans.php?deleteid='.$rowsvalues['id'].'\');"><i class="el el-trash"></i></a>';
									}
									echo'
								</td>
							</tr>';
