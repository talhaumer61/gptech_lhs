                    ...
                    <table class="table table-hover table-striped table-condensed mb-none">
                        ...
                        <tbody>';
                                ...
                                while($valCats = mysqli_fetch_array($sqllmsCats)) {
                                    $srno++;
                                    echo '
                                    <input type="hidden" name="id_cat['.$srno.']" id="id_cat['.$srno.']" value="'.$valCats['cat_id'].'">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group" id="getconcessiontype-'.$srno.'">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" class="form-control amount" name="amount[]" id="amount" min="0" max="<script>document.writeln(tuitionfee);</script>" required title="Must Be Required"/>
                                                </div>
                                                <label class="col-md-3 control-label">Percentage </label>
                                                <div class="col-md-9 mt-xs">
                                                    <input type="number" class="form-control" name="percent[]" id="conpercentage" min="0" max="100" required title="Amount should be greater than 0 & less than 100"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>';?>
