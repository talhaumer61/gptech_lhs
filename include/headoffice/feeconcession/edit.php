...
if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '70', 'view' => '1'))){   
    ...
    $sqllms	= $dblms->querylms("SELECT id, status, id_cat, id_class, id_std
                                        FROM ".SCHOLARSHIP."
                                        WHERE id_type = '2' AND id = '".cleanvars($_GET['id'])."'
                                        LIMIT 1");
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" name="id_std" name="id_std" disabled>
                                    ...
                                    $sqllmsstudent	= $dblms->querylms("SELECT std_id, std_name 
                                                                            FROM ".STUDENTS."
                                                                            WHERE std_id = '".$rowsvalues['id_std']."' LIMIT 1");
                    ...
                    <table class="table table-hover table-striped table-condensed mb-none">
                        ...
                        <tbody>';
                                $sqllmsCats  = $dblms->querylms("SELECT c.cat_id, c.cat_name, d.amount
                                                                    ...
                                                                    WHERE cat_status = '1' AND s.std_id = '".$rowsvalues['id_std']."' AND f.id_class = '".$rowsvalues['id_class']."'
                                                                    ORDER BY cat_name ASC");
                                $srno = 0;
                                while($valCats = mysqli_fetch_array($sqllmsCats)) {
                                    ...
                                    $srno++;
                                    if($valDet['from_month'] == 0 && $valDet['to_month'] == 0) { 
                                        $forSession = 'selected';
                                        $forCustom = '';
                                    } else {
                                        $forSession = '';
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group mt-sm">
                                                <div class="col-md-12 mt-md">
                                                    <input type="number" class="form-control" name="cat_amount['.$srno.']" id="cat_amount'.$srno.'" value="'.$valCats['amount'].'" disabled>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group mt-sm">
                                                <div class="col-md-12 mt-md">
                                                    <select class="form-control" name="duration[]" id="duration[]" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" onchange="get_concession_fields'.$srno.'(this.value)" disabled>
                                        ...
                                        <td>
                                            <div class="form-group" id="getconcessiontype'.$srno.'">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="number" class="form-control" name="con_percent['.$srno.']" id="con_percent'.$srno.'" min="0" max="100" value="'.$valDet['percent'].'" required title="Amount should be greater than 0 & less than 100" disabled/>
                                                </div>
                                                <label class="col-md-3 control-label">Amount </label>
                                                <div class="col-md-9 mt-xs">
                                                    <input type="number" class="form-control" name="con_amount['.$srno.']" id="con_amount'.$srno.'" value="'.$valDet['amount'].'" required title="Must Be Required" disabled/>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <div class="col-md-12 mb-xs">
                                                    <select class="form-control" name="duration['.$srno.']" id="duration['.$srno.']" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" onchange="get_duration_fields'.$srno.'(this.value)" disabled>
                                                        <option vlaue="">Select</option>
                                                ...
                                                <div id="getDuration'.$srno.'">'; 
                                                    if($forCustom == 'selected') {
                                                        ...
                                                        <div class="form-group mt-sm">
                                                            <div class="col-md-12">
                                                                <div class="col-md-6">
                                                                    <select class="form-control" name="from['.$srno.']" id="from'.$srno.'" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" disabled>
                                                                        <option>From</option>';
                                                                ...
                                                                <div class="col-md-6">
                                                                    <select class="form-control" name="to['.$srno.']" id="to'.$srno.'" required title="Must Be Required" data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" disabled>
                                                                        <option>To</option>';
                                                                        foreach($monthtypes as $months) {
