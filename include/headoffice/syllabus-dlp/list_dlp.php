				...
				<tbody>';
					...
					while($rowsvalues = mysqli_fetch_array($sqllms)) {
						...
						<tr>
							...
							<td class="center">Week '.$rowsvalues['id_week'].'</td>
							...
							echo'
								<a class="btn btn-danger btn-xs" onclick="confirm_modal(\'syllabus_dlp.php?deleteid='.$rowsvalues['syllabus_id'].'\');"><i class="el el-trash"></i></a>';
							}
							echo'
							</td>
						</tr>';
