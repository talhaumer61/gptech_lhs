...
//---------------------------------------------------------
	$sqllms	= $dblms->querylms("SELECT  res_id, res_status, res_file, id_subject, id_class, week, id_term, id_session, note
	...
	<input type="hidden" name="res_id" id="res_id" value="'.cleanvars($_GET['id']).'">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="file" class="form-control" name="res_file" id="res_file" value="'.$rowsvalues['res_file'].'"/>
				</div>
			</div>
			<div class="form-group mb-md">
