...
//---------------------------------------------------------
	$sqllms	= $dblms->querylms("SELECT id, status, title, term, id_session, file, id_class, id_subject, note
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" required title="Must Be Required" name="term">
							<option value="">Select</option>
							<option value="1"'; if($rowsvalues['term'] == 1){echo ' selected';} echo '>First Term</option>
							<option value="2"'; if($rowsvalues['term'] == 2){echo ' selected';} echo '>Second Term</option>
						</select>
					</div>
				</div>
				<div class="form-group">
