...
<section class="panel panel-featured panel-featured-primary">
	<form action="stationary-category.php" class="form-horizontal" id="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
		...
		<header class="panel-heading">
			<h2 class="panel-title"><i class="glyphicon glyphicon-folder-close"></i> Invoice Details</h2>
		</header>
		<div class="panel-body">
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<td colspan="3"><span class="label label-info">'.$order['customer']['invoice_no'].'</span>
						<span style="float:right;">
							<a class="btn btn-xs btn-purple" href="invoiceprint.php?id='.$_GET['id'].'" target="_blank"><i class="glyphicon glyphicon-print"></i></a>
						</span>
					</td> 
				</tr>
				<tr>	
				...
				<tr>
					...
					<td colspan="3">'.$order['customer']['remarks'].'</td>
				</tr>
			</tbody>
		</table> 
		...
		<tr>
			<th colspan="5" style="text-align:right; font-weight:bold;">Previous Balalnce: </th>
			<th colspan="2" style="text-align:right; font-weight:600; color:#f00;">'.number_format($order['customer']['opening_balance']).'</th>
		</tr>
		<tr>
			<th colspan="5" style="text-align:right; font-weight:bold;">Total Amount: </th>
			<th colspan="2" style="text-align:right; font-weight:600;">'.number_format($order['customer']['grand_total']).'</th>
		</tr>
		<tr>
			<th colspan="5" style="text-align:right; font-weight:bold;">Advance: </th>
			<th colspan="2" style="text-align:right; font-weight:600;">'.number_format($order['customer']['advance']).'</th>
		</tr>
		<tr>
			<th colspan="5" style="text-align:right; font-weight:bold;">Total Receiveable: </th>
			<th colspan="2" style="text-align:right; font-weight:600;">'.number_format(($order['customer']['grand_total'] - $order['customer']['advance'])).'</th>
		</tr>
		</thead>
		</table>
		</div>
