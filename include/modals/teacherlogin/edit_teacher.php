	...
	<input type="hidden" name="adm_id" id="adm_id" value="'.cleanvars($_GET['id']).'">
		...
		<div class="panel-body">
			...
			<div class="form-group mt-sm">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="adm_email" name="adm_email" value="'.$rowsvalues['adm_email'].'" required title="Must Be Required" readonly/>
				</div>
			</div>
			<div class="form-group mt-sm">
				<label class="col-md-3 control-label"> Phone </label>
				<div class="col-md-9">
					<input type="text" class="form-control" id="adm_phone" name="adm_phone" value="'.$rowsvalues['adm_phone'].'" required title="Must Be Required" />
				</div>
			</div>
			<div class="form-group mt-sm">
