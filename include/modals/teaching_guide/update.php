...
//---------------------------------------------------------
	$sqllms	= $dblms->querylms("SELECT guide_id, guide_status, guide_title, guide_term, id_session, guide_file, id_class, id_subject, note
	...
	<input type="hidden" name="guide_id" id="guide_id" value="'.cleanvars($_GET['guide_id']).'">
		...
		<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<select class="form-control" required data-plugin-selectTwo data-width="100%" data-minimum-results-for-search="Infinity" required title="Must Be Required" name="guide_term">
							<option value="">Select</option>
							<option value="1"'; if($rowsvalues['guide_term'] == 1){echo ' selected';} echo '>First Term</option>
							<option value="2"'; if($rowsvalues['guide_term'] == 2){echo ' selected';} echo '>Second Term</option>
						</select>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="file" class="form-control" name="guide_file" id="guide_file" value="'.$rowsvalues['guide_file'].'"/>
				</div>
			</div>
			<div class="form-group mb-md">
