...
<section class="panel panel-featured panel-featured-primary">
    ...
    <div class="panel-body">';
        $sqllmsassignment	= $dblms->querylms("SELECT a.assig_id, a.assig_status, a.assig_title, a.assig_file, a.assig_note, a.open_date, a.close_date,
                                                ...
                                                AND a.id_teacher = '".$value_emp['emply_id']."'
                                            ");
                ...
                <tbody>';
                    ...
                    while($value_assign = mysqli_fetch_assoc($sqllmsassignment)) { 
                        ...
                        <tr>
                            ...
                            <td class="center">'.$value_assign['class_name'].'</td>
                            <td class="center">'.$value_assign['section_name'].'</td>
                            ...
                            <td class="center">';
                            if(!empty($value_assign['assign_file'])){
                                echo'<a href="uploads/resources/'.$value_assign['assig_file'].'" download="'.$value_assign['assig_file'].'" class="btn btn-success btn-xs mr-xs");"><i class="glyphicon glyphicon-download"></i> </a>';
                            }                            
