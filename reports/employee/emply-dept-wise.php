...
<head>
<meta charset="utf-8">
<title>Department Wise Staff Details</title>
<style type="text/css">
        ...
        <tr>
            <td width="341" valign="top">
                <div class="row">
                    ...
                    <h4>Department Wise Staff Details</h4>
                </div>
                ...
                <div class="line1"></div>';
                    ...
                    $sqllmsDept = $dblms->querylms("SELECT dept_id, dept_name
                                                            FROM ".DEPARTMENTS." 
                                                            WHERE dept_status = '1' AND is_deleted != '1'
                                                  ");
                    while($rowsDept = mysqli_fetch_array($sqllmsDept)) {

                        echo'
                        <h3 style="text-align: left; margin-top: 10px;">'.$rowsDept['dept_name'].'</h3>
                            ...
                            <table style="width:100%; border-collapse:collapse; margin-top: 10px;" border="1">
                                <tbody>				
                                    ...
                                    $sqllmsEmply = $dblms->querylms("SELECT d.designation_name, e.emply_name, e.emply_regno, e.emply_joindate
                                                                            ...
                                                                            WHERE e.emply_status = '1' AND e.is_deleted != '1'
                                                                            AND e.id_dept = '".$rowsDept['dept_id']."'
                                                                            AND e.id_campus = '".$_SESSION['userlogininfo']['LOGINCAMPUS']."'  
                                                                            ");
                                    if(mysqli_num_rows($sqllmsEmply)){
