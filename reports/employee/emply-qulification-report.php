...
<head>
<meta charset="utf-8">
<title>Details Of Teachers Qualification</title>
<style type="text/css">
        ...
        <tr>
            <td width="341" valign="top">
                <div class="row">
                    ...
                    <h4>Details Of Teachers Qualification</h4>
                </div>
                <div class="line1"></div>
                        ...
                        <table style="width:100%; border-collapse:collapse; margin-top: 10px;" border="1">
                            <tbody>				
                                <tr>
                                    ...
                                    <th>Registration</th>
                                    <th>Name</th>
                                    <th>Professional Qulaification</th>
                                    <th>Academic Qulaification</th>
                                    <th>Experience</th>
                                </tr>';

                                $srno = 0;

                                $sqllmsEmply = $dblms->querylms("SELECT emply_name, emply_regno, emply_joindate, emply_education, emply_experence
                                                                        FROM ".EMPLOYEES."
                                ...
                                while($valEmply = mysqli_fetch_array($sqllmsEmply)) {
                                    ...
                                    <tr>';
                                        ...
                                        <td>'.$valEmply['emply_education'].'</td>
                                        <td>'.$valEmply['emply_education'].'</td>
                                        <td>'.$valEmply['emply_experence'].'</td>
                                    </tr>';
                                }
                                echo'
                            </tbody>
