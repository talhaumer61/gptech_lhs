    ...
    <div class="row">
        <div class="col-md-12">';
	        if($_SESSION['userlogininfo']['LOGINAFOR'] == 1){
                //-----------------------------------------------
                include_once("include/headoffice/royalty/query.php");
                if($view == 'add'){
                    include_once("include/headoffice/royalty/add.php");
                } else if(isset($_GET['id'])){
                    include_once("include/headoffice/royalty/edit.php");
                } else {
                    include_once("include/headoffice/royalty/list.php");
                }
                //-----------------------------------------------
            }  else{
